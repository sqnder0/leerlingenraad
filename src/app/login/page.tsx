  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-gradient-to-br from-brand-50 via-white to-brand-100 p-6">
      ...
      >
        ...
        <h1 className="text-center text-lg font-semibold text-brand-900">Inloggen</h1>
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            required
            className="rounded-lg border border-brand-600/25 bg-white px-3 py-2 text-sm text-brand-900 shadow-sm outline-none transition-shadow focus:border-brand-600 focus:ring-2 focus:ring-brand-500/30"
          />
        </div>

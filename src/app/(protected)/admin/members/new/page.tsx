...
export default function NewMemberPage() {
  ...
  if (state.status === "success") {
    return (
      <div className="flex flex-1 flex-col gap-4 p-6">
        <h1 className="text-xl font-semibold text-brand-900">Lid aangemaakt</h1>
        ...
        <dl className="w-fit rounded-xl border border-brand-600/15 bg-brand-50/50 p-4 text-sm">
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-6">
      <h1 className="text-xl font-semibold text-brand-900">Nieuw lid</h1>

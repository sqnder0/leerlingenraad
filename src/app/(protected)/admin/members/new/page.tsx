...
export default function NewMemberPage() {
    ...
    return (
      <div className="flex flex-1 flex-col items-center gap-4 p-6">
        <div className="w-full max-w-sm">
          <h1 className="mb-4 text-xl font-semibold text-brand-900">Lid aangemaakt</h1>
          <p className="text-zinc-600">
            Geef deze inloggegevens door aan het lid, ze worden hierna niet meer getoond. Het
            account staat nog op <strong>PENDING</strong> tot je het goedkeurt op de ledenlijst.
          </p>
          <dl className="mt-4 w-fit rounded-xl border border-brand-600/15 bg-brand-50/50 p-4 text-sm">
  ...
  return (
    <div className="flex flex-1 flex-col items-center gap-4 p-6">
      <div className="w-full max-w-sm">
        <h1 className="mb-4 text-xl font-semibold text-brand-900">Nieuw lid</h1>

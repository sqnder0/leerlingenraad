...
- `/events/[eventId]` — details + RSVP toggle, shows who else is going, never points
- `/my/signups` — own RSVP/attendance history
...
- **M3 — Events + RSVP**: admin event CRUD (scoped to active school year), member events list/detail, RSVP action, `/my/signups`
